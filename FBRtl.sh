...
ku='\033[33;1m' #kuning
# [SUBSCRIBE] Am_p5
figlet -f standard FBRtl Tools | lolcat
echo
...
echo $i"========================================"
echo
echo $me"┌==="$bi"["$i"Am_p5"$bi"]"$me"======"$bi"["$i""Masukan Nomor""$bi"]"
echo $me"¦"
read -p"└──# " pil
...
echo $ku"Blog    :"$i" www.kepo.com"
echo $ku"Instagram :"$i" @xxxx_xxxx2012"
sleep 2
